...
const schedule = [
	...
	{
		time: '21:00',
		title: 'Торт и огни в честь завершения вечера',
		text: 'Если вы думали, что ужин - это всё, то нет. Время отведать кусочек торта и зажечь бенгальские огни в честь завершения свадебного вечера',
	},
	{
		time: '22:30',
		title: 'Окончание вечера',
		text: 'Время завершения торжества! Спасибо, что были с нами в этот важный день и разделили его радость с нами!',
	},
]
...
const wishes = [
	...
	'Дарить цветы в день свадьбы совершенно не обязательно. Мы не успеем насладиться красотой всех букетов. Лучше позаботьтесь о своём транспорте до места празднования.',
